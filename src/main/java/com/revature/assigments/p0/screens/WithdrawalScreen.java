...
public class WithdrawalScreen extends Screen{
    ...
    public void render() {
        ...
        if (userTracker.getUser().getAccounts().size() > 0){
            System.out.println("In which account would you like to withdrawal? ");
            System.out.println("--------------------------------------------");
            ...
            try{
                ...
                System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
                System.out.printf("Are you planning to withdrawal $ %.2f%n into your Account # %s Type: %s",
                ...
                System.out.println(">>>>> Are you planning to continue with your withdrawal?");
                System.out.printf(">>>>> (yes or no) >> ");
                try{
                    String userConfirm = consoleReader.readLine();
                    if ( userConfirm.trim().toLowerCase().equals("yes")){
